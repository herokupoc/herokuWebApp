CREATE OR REPLACE FUNCTION herokuacu.hc_contact_status()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
                    BEGIN
                      ...
                      ELSE  -- connect op
                       ...
                       NEW._hc_lastop = 'SYNCED';
                        NEW._hc_err = NULL;
                        	INSERT INTO util.t_util_log (insert_time, log_locale, log_msg) VALUES(current_timestamp, 'herokuacu TG_OP:', TG_OP);
